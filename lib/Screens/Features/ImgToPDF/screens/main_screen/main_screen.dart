...
import 'package:job_apply_hub/Screens/Features/ImgToPDF/logic/logic.dart';
import 'package:job_apply_hub/Screens/Features/ImgToPDF/screens/exit_screen/exit_screen.dart';
import 'package:job_apply_hub/Screens/Features/ImgToPDF/widgets/general_button.dart';
import 'package:job_apply_hub/Screens/Features/ImgToPDF/widgets/select_image_card.dart';
import 'package:open_filex/open_filex.dart';

class MainScreenImgToPDF extends StatefulWidget {
  const MainScreenImgToPDF({Key? key}) : super(key: key);

  @override
  State<MainScreenImgToPDF> createState() => _MainScreenState();
}

class _MainScreenState extends State<MainScreenImgToPDF> {
