...
class _ExitScreenState extends State<ExitScreen> {
  ...
  onTap: () async {
    if (controller.text.isNotEmpty) {
      try {
        final documentSaver = DocumentFileSavePlus();
        await documentSaver.saveFile(
            data.pdf.value!.readAsBytesSync(),
            "${controller.text}.pdf",
            "application/pdf"
        );
      ...
      Fluttertoast.showToast(msg: "Please give a name to your file");
    }
  },
